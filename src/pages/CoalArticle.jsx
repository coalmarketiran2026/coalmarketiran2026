...
function CoalArticle() {
  // دریافت مسیر پایه (مثل /coalmarketiran2026/)
  ...
  return (
    <section className="article-page">
      ...
      <div className="article-hero">
        ...
        <img
          /* دقت کن: اینجا قبل از images اسلش نگذاشتم تا با basePath ترکیب نشود */
          src={`${basePath}images/coal-banner.jpg`}
          alt="Coal"
        />
        ...
        <div className="article-content">
          ...
          <div className="feature-grid">
            ...
            <div className="feature-box">
              ...
              <p>مناسب برای نیروگاه‌ها و صنایع انرژی‌بر</p>
            </div>

            <div className="feature-box">
              <FaIndustry />
              <h3>کاربرد صنعتی</h3>
              <p>فولاد، سیمان، آهک، ریخته‌گری و صنایع شیمیایی</p>
            </div>

            <div className="feature-box">
              <FaFlask />
              <h3>آنالیز آزمایشگاهی</h3>
              <p>بررسی Ash، Sulfur، Moisture، GCV و FC</p>
            </div>
